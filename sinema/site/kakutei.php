...
<link rel="stylesheet" type="text/css" href="css/kakutei.css">
</head>
<body>
  <div class="sidebar">
    <ul>
...
<button id="sidebar-close-menu">閉じる</button>
  ...
  <div class="content">
    ...
    <div class="container">
      <h2 class="registration-complete-title">購入完了</h2>
      <p class="registration-complete-message">購入が正常に完了しました。</p>
      <button class="registration-complete-back-button" onclick="location.href='index.php'">トップページに戻る</button>
    </div>
