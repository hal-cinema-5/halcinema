...
// $day3_p = $_SESSION['day3_p'];
// $day4_p = $_SESSION['day4_p'];
// $day5_p = $_SESSION['day5_p'];
echo "1日目$day1_p  ";
echo "1日目セレクト$selected_days1  ";
echo "2日目$day2_p  ";
...
<button id="sidebar-close-menu">閉じる</button>
  ...
  <form action="" method="post">
    ...
    <a href="#" class="schedule-button">
      <time class="schedule-date" datetime=""><?php echo date("m/d". $week3 ."", $Day3) . "\n"; ?></time>
    </a>
    <a href="#" class="schedule-button">
      <time class="schedule-date" datetime=""><?php echo date("m/d". $week4 ."", $Day4) . "\n"; ?></time>
    </a>
    <a href="#" class="schedule-button">
      <time class="schedule-date" datetime=""><?php echo date("m/d". $week5 ."", $Day5) . "\n"; ?></time>
    </a>
  </div>
...
<h3>
  <time>aaa<?php  echo date("Y/m/d". $week2 ."", $Day2) . "\n"; ?></time>
</h3>

<div class="movie-info">
    <h4>　<?php echo $screen1[0][4]; ?>　　　　　
      <a href="jouhou.php" class="info-button">映画情報へ</a>　　
    </h4>
      </div>
    <ul class="timetable">
      ...
      <li>
        <a href="kounyu.php" method="post" value="ボタン1">
          <time class="start"><?php echo $screen1[0][2]; ?></time>
          ～
          <time class="end"><?php echo $screen1[0][3]; ?></time>
          <div class="close">
            販売終了
          </div>
        </a>
