  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <table class="screen-table">
        <tr>
          <td>
            <a href="images/scr.pdf" class="screen-link">
              <div class="screen">
                <div class="screen-name">スクリーン1・2・3</div>
                <div class="screen-info">座席数: 200</div>
              </div>
            </a>
          </td>
          <td>
            <a href="images/scr2.pdf" class="screen-link">
              <div class="screen">
                <div class="screen-name">スクリーン4・5</div>
                <div class="screen-info">座席数: 120</div>
              </div>
            </a>
          </td>
          <td>
            <a href="images/scr3.pdf" class="screen-link">
              <div class="screen">
                <div class="screen-name">スクリーン6・7・8</div>
    ...
    <div class="container">
      ...
      <h2>HALシネマ</h2>
      <br>
      <p class="address">〒450-0002 愛知県名古屋市中村区名駅４丁目２７−１ 総合校舎スパイラルタワーズ</p>
      <p class="description">当映画館のアクセスは便利な場所に位置しています。お気軽にお越しください。</p>
    </div>

    <div class="container">
      <h2>営業時間</h2>
      <p class="gyoukan">平日：9:30～最終上映開始時刻まで</p>
      <p class="gyoukan">土日祝：9:00～最終上映開始時刻まで</p>
    </div>
